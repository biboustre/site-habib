export const  cardNosCreation = [
    {
      ...
      description: "Authentification et Réservation par QR Code pour l'Application L'Adhésion. Dans le cadre de l'application L'Adhésion, j'ai conçu et développé un système d'authentification avancé basé sur le QR code, spécifiquement conçu pour simplifier l'expérience des membres d'une association. Grâce à cette solution, les adhérents peuvent non seulement se connecter de manière sécurisée, mais aussi réserver leurs billets pour des événements en utilisant un simple scan de QR code. Cette innovation apporte à la fois sécurité et rapidité, rendant l'accès aux fonctionnalités de l'application plus fluide et intuitif.",
