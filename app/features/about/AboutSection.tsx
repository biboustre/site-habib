...
export default function AboutSection () {
  return (
    ...
    //   />
    // </section>
    <section className="flex h-screen scroll-mt-[100px] flex-col  gap-20 py-10 bg-black text-white md:gap-40">
    <DuplicatedText className="mt-10 md:text-5xl" duplicatedClassName='-top-6' text="Nous créons et améliorons les <br /> produits Web et mobiles" />
