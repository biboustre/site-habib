  ...
  return (
    <section className="bg-gblack flex h-auto flex-col items-center justify-center gap-14 px-2 py-32 text-white sm:px-3 md:px-0 lg:flex-row lg:items-stretch">
      ...
      <section className="flex flex-col gap-16 lg:w-2/3">
        {/* Texte de la section */}
        <section className="btn-gradient flex cursor-default items-center justify-center rounded-lg transition duration-300 hover:scale-95 md:justify-start ">
          <h1 className="animate-text-gradient max-w-[1200px] p-10 text-center text-2xl font-bold hover:text-white lg:text-start xl:text-[25px] 2xl:py-16 2xl:text-3xl">
            Nous proposons une gamme de services de design graphique. Que ce
            soit pour la création de flyers, logos, ou de cartes de restaurant.
          </h1>
        </section>
...
const ServiceCard = ({
  ...
  return (
    <div
      className="perspective-1000 relative h-[250px] max-h-[350px] w-full max-w-[500px] basis-full cursor-pointer overflow-hidden rounded-3xl bg-neutral-900/30 shadow-sm shadow-yellow-900 md:min-h-[350px] md:basis-1/3 lg:size-[20vw]"
