...
const BannerMarketing: React.FC<BannerMarketingProps> = ({
  ...
  return (
    ...
    >
      ...
      <section className="py- relative h-auto">
      <div className="absolute inset-0 bg-black/50 pointer-events-none rounded-xl"></div>
        ...
        <div className="absolute inset-0 bg-black/40 pointer-events-none rounded-xl"></div>
          ...
          <section className="space-y-10 z-10 px-2 text-center text-white sm:pt-20 md:px-0">
          ...
          {/* Boutons */}
          <section className="flex flex-col z-10 items-center justify-center gap-5 md:flex-row md:space-x-10">
