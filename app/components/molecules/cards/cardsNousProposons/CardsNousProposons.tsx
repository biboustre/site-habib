...
export default function CardsNousProposons({
  ...
  return (
    <section
      className={`flex h-[550px] w-auto cursor-pointer flex-col items-center justify-between gap-9 rounded-xl bg-neutral-800/50 px-2 py-10 duration-300 hover:scale-95 md:size-[550px] md:rounded-full 2xl:size-[800px] ${className}`}
    >
